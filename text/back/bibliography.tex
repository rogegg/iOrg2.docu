...
\bibitem{user_exp}  Juan Manuel Carraro y Yanina Duarte, 2015, ``Diseño de experiencia de usuario (UX)'', Editorial Autores de Argentina(1ª ed.).


\bibitem{sqlite}  Stuart Hall, April 4, 2015, ``How to create a database in python using sql lite 3''.

\bibitem{html5}  Dane Cameron, November 25, 2013, ``A Software Engineer Learns HTML5, JavaScript and jQuery'', CreateSpace Independent Publishing Platform; 1st edition.

\bibitem{css3}  Ben Frain, August 24, 2015, ``Responsive Web Design with HTML5 and CSS3'', Packt Publishing; 2nd edition.
...
\bibitem{user_exp2}``Importancia de la interfaz de usuario'', "Spais", 2007, Fecha de último acceso: 11/04/2017.\\\href{http://spaisdaniela-imdtp1.blogspot.com.es/2007/04/importancia-de-la-interfaz-de-usuario.html}{http://spaisdaniela-imdtp1.blogspot.com.es/2007/04/importancia-de-la-interfaz-de-usuario.html}
